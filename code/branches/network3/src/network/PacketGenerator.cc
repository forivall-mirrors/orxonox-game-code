...
namespace network
{
  ...
  ENetPacket* PacketGenerator::gstate( GameStateCompressed* states, int reliable )
  {
    ...
    int totalLen = 5*sizeof( int ) + sizeof(bool) + states->compsize; //calculate the total size of the datastream memory
    ...
    memcpy( (void*)(data+5*sizeof( int ) + sizeof(bool)), (const void*)states->data, states->compsize );
