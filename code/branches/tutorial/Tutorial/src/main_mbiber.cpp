...
public:
    ...
    bool frameStarted(const FrameEvent &evt)
    {
        ...
        // ...
	lightNode->translate(Vector3(r*sin(phi),r*cos(phi),0));
	r+=0.1*evt.timeSinceLastFrame;
	phi+=1*evt.timeSinceLastFrame;
...
protected:
	...
	bbs->createBillboard(Vector3::ZERO,ColourValue(0.0,1.0,1.0));
