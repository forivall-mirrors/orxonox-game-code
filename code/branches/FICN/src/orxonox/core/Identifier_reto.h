...
namespace orxonox
{
    ...
    */
    ...
    class ClassIdentifier : public Identifier
    {
        public:
            ...
            /** @returns the ClassIdentifier. */
            static inline ClassIdentifier<T>* getIdentifier() { return getIdentifier("unknown class"); }
    ...
    */
    ...
    {
        COUT(4) << "*** Create ClassIdentifier singleton for class " << name << "." << std::endl;
        this->objects_ = new ObjectList<T>;
    }

    /**
        @brief Destructor: Deletes the ObjectList.
    */
    template <class T>
    ...
    */
    ...
    ClassIdentifier<T>* ClassIdentifier<T>::registerClass(const IdentifierList* parents, const std::string& name, bool bRootClass)
    {
        ...
        if (!getIdentifier(name)->bCreatedOneObject_)
        {
    ...
    /**
        @returns the Identifier itself and creates debug output.
        @param name The name of the class.
    */
    template <class T>
    ClassIdentifier<T>* ClassIdentifier<T>::getIdentifier(const std::string& name)
    {
        static ClassIdentifier<T> theOneAndOnlyInstance = ClassIdentifier<T>(name);
