...
namespace orxonox
{
    ...
    class _CoreExport BaseObject : virtual public OrxonoxClass
    {
        ...
        public:
            ...
            bool isInitialized() const { return this->bInitialized_; }

            /** @brief Sets the name of the object. @param name The name */
            void setName(const std::string& name) { this->name_ = name; this->changedName(); }
            ...
            void setActivity(bool bActive) { this->bActive_ = bActive; this->changedActivity(); }
            /** @brief Returns the state of the objects activity. @return The state of the activity */
            bool isActive() const { return this->bActive_; }
            ...
            void setVisibility(bool bVisible) { this->bVisible_ = bVisible; this->changedVisibility(); }
            /** @brief Returns the state of the objects visibility. @return The state of the visibility */
            bool isVisible() const { return this->bVisible_; }
            ...
            void setLevel(const Level* level) { this->level_ = level; }
            /** @brief Returns a pointer to the level that loaded this object. @return The level */
            const Level* getLevel() const { return this->level_; }
            const std::string& getLevelfile() const;

            virtual void setNamespace(Namespace* ns) { this->namespace_ = ns; }
            Namespace* getNamespace() const { return this->namespace_; }

            /** @brief Sets the indentation of the debug output in the Loader. @param indentation The indentation */
            void setLoaderIndentation(const std::string& indentation) { this->loaderIndentation_ = indentation; }
            /** @brief Returns the indentation of the debug output in the Loader. @return The indentation */
            const std::string& getLoaderIndentation() const { return this->loaderIndentation_; }
