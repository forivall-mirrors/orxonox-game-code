...
namespace orxonox
{
    ...
    class _OrxonoxExport Planet : public PositionableEntity, public Tickable
    {
        public:
...
#endif /* _Planet_H__ */
//<Planet position="200000,0,0" scale="10000" mesh="planet.mesh" yawpitchroll="-40,30,0" rotationAxis="1,0,0" rotationRate="0"/>
