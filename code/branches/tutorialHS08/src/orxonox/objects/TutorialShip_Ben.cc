...
namespace orxonox
{
    ...
    SetConsoleCommand(TutorialShip, fire, true).keybindMode(KeybindMode::OnPress);
    ...
    {
        SetConfigValue(reloadTime_, 0.125).description("standard reload time");
    }
    ...
    void TutorialShip::XMLPort(Element& xmlelement, XMLPort::Mode mode)
    {
        ...
        COUT(3) << "special effects enabled" << std::endl;
